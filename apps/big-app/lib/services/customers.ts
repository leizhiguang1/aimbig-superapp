...
function normalize(input: unknown) {
	...
	return {
		...
		emergency_contact_name: nz(p.emergency_contact_name),
		emergency_contact_phone: nz(p.emergency_contact_phone),
		emergency_contact_relationship: nz(p.emergency_contact_relationship),
