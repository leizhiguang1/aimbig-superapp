...
// Summary functions (getSalesSummary, getSaleItemBreakdownByType, getCashSummary)
// live in @/lib/services/sales-summary.ts. Re-exported here so existing imports
// from @/lib/services/sales keep working.
export {
	type CashSummary,
	getCashSummary,
	getSaleItemBreakdownByType,
	type SaleItemTypeBreakdown,
	getSalesSummary,
	type SalesSummary,
} from "@/lib/services/sales-summary";
...
// Read-side assemblies (getNewSaleData, getSalesOrderDetail) live in
// @/lib/services/sales-assemblies.ts. Re-exported here so existing imports
// from @/lib/services/sales keep working.
export {
	getNewSaleData,
	getSalesOrderDetail,
...
} from "@/lib/services/sales-assemblies";
